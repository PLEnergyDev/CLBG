...
static inline __m256d mm256_rsqrt_pd(__m256d s) {
...
static double energy(const double *m, __m256d *p, __m256d *v) {
    double e = 0.0;
...
static void advance(double dt, double *m, __m256d *p, __m256d *v) {
    __m256d r[PAIRS+3];
    double w[PAIRS+3] __attribute__((aligned(sizeof(__m256d))));
